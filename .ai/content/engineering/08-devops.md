...
A plataforma é desenhada com a nuvem pública como destino de produção, com atenção a requisitos de disponibilidade, escalabilidade horizontal e operação multiempresa segura à medida que o volume de uso crescer.

Observabilidade — a capacidade de entender o que está acontecendo dentro da plataforma em operação — é tratada como um requisito de maturidade a ser fortalecido nas próximas fases, incluindo métricas de uso, saúde da aplicação e rastreamento de operações críticas de negócio.
