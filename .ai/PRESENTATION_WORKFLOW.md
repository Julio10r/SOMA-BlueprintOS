...
> Fluxo oficial para criação de qualquer apresentação no SOMA BlueprintOS. Nenhuma apresentação deve começar do zero — todo o fluxo abaixo reutiliza os assets consolidados em `resources/design-system/` (Sprint B2.1).

Antes de iniciar, todo agente deve consultar, nesta ordem:

1. `resources/design-system/SKILL.md`
2. `resources/design-system/INDEX.md`
3. `resources/design-system/templates/powerpoint/`
...
- Salvar em `resources/presentations/<Nome da Apresentação>.md`.
...
- Salvar em `resources/presentations/<Nome da Apresentação> Executive Review.md`.
...
- Deve referenciar exclusivamente tokens/componentes existentes em `resources/design-system/` (cores, tipografia, `preview/*.html`, `assets/`).
- Salvar em `resources/presentations/<Nome da Apresentação> Storyboard.md`.
- Ver `resources/presentations/Executive Report Storyboard.md` como referência de formato.

## 4. Design Mapping

- Mapa de rastreabilidade slide-a-slide: quais componentes, assets, tokens de cor e tipografia de `resources/design-system/` foram efetivamente usados, com caminho de arquivo e justificativa.
- Nenhum item genérico ou inventado — sempre apontar para o arquivo real.
- Salvar em `resources/presentations/<Nome da Apresentação> Design Mapping.md`.
- Ver `resources/presentations/Executive Report Design Mapping.md` como referência de formato.

## 5. Geração PowerPoint

- Partir sempre de um dos masters em `resources/design-system/templates/powerpoint/` (`Master-Cover.pptx`, `Master-Section.pptx`, `Master-Content.pptx`, `Master-Timeline.pptx`, `Master-Architecture.pptx`, `Master-Closing.pptx`) ou do `AZZAS-2154-Template.pptx` completo.
...
- Resultado: `resources/presentations/<Nome da Apresentação>.pptx`.
- Seguir padrões de resolução, grid, margens e espaçamento em `resources/design-system/presentations/README.md`.

## 6. Exportação PDF

- Exportar o `.pptx` final para PDF em alta qualidade.
- Resultado: `resources/presentations/<Nome da Apresentação>.pdf`, nome espelhado ao `.pptx`.
...
- Salvar em `resources/presentations/<Nome da Apresentação> QA.md`.
- Ver `resources/presentations/Executive Report QA.md` como referência de formato.
