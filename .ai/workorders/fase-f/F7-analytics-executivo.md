# Work Order — F7 — Analytics Executivo
...
- Dependências: F1 a F6; D/E propostos.
- Data de aprovação: Não aprovada

## Objetivo

Consolidar savings, riscos, previsões, eficiência, compliance e oportunidades para gestão.
