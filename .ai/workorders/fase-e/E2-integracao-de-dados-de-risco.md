# Work Order — E2 — Integração de Dados de Risco
...
- Dependências: E1 e G1.
- Data de aprovação: Não aprovada

## Objetivo

Consumir fontes internas e externas autorizadas sobre situação financeira, fiscal, operacional e reputacional.
