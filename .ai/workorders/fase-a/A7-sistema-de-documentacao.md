# Work Order — A7 — Sistema de Documentação
...
Implementar geração e publicação de documentação executiva, cliente e engenharia nos formatos definidos.
...
Evidência Git e código Documentation/Publication.
