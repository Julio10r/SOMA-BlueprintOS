# Work Order — H1 — Identidade Corporativa com Entra ID
...
- Dependências: A1; tenant Entra a aprovar.
- Data de aprovação: Não aprovada

## Objetivo

Implementar autenticação, claims, grupos, usuários, service principals e integração com Microsoft Entra ID.
