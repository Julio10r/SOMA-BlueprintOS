# Work Order — H6 — Plataforma Cloud e CI/CD
...
- Dependências: H1 a H5; G1.
- Data de aprovação: Não aprovada

## Objetivo

Preparar Google Cloud, pipelines, ambientes, secrets, infraestrutura como código, backup e recuperação.
