# Work Order — C4 — Memória Persistente de Negociação
...
- Dependências: C3; persistência proposta.
- Data de aprovação: Não aprovada

## Objetivo

Persistir interações, propostas, contrapropostas, decisões, aprendizados e resultados.
