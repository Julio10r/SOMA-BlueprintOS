# Work Order — D1 — Integração com Plataforma Jurídica

## Metadados

- Fase: Contract & Compliance
- Sprint: D1
- Status: Draft
- Prioridade: Priorização pendente do Product Owner
- Dependências: G1; plataforma jurídica a aprovar.
- Data de aprovação: Não aprovada

## Objetivo

Criar contratos de integração para consulta de contratos, vigência, partes, status e metadados jurídicos.
...
G1; plataforma jurídica a aprovar.
