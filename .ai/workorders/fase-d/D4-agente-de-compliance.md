# Work Order — D4 — Agente de Compliance
...
- Dependências: D3, Knowledge e AI Runtime.
- Data de aprovação: Não aprovada

## Objetivo

Avaliar processos de compra, explicar inconsistências e recomendar correções antes da aprovação.
