# Work Order — G2 — Integração ERP de Requisições
...
- Dependências: G1; ERP a identificar.
- Data de aprovação: Não aprovada

## Objetivo

Receber requisições e demandas dos diferentes ERPs das unidades de negócio.
