# Work Order — G6 — Portal e Marketplace de Fornecedores
...
- Dependências: B1, G1 e H1/H2.
- Data de aprovação: Não aprovada

## Objetivo

Permitir interação controlada de fornecedores para cadastro, documentos, propostas e acompanhamento.
