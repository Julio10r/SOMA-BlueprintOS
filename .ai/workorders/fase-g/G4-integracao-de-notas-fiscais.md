# Work Order — G4 — Integração de Notas Fiscais
...
- Dependências: G1 e G3.
- Data de aprovação: Não aprovada

## Objetivo

Consultar e registrar informações de notas fiscais e seu vínculo com pedidos e fornecedores.
