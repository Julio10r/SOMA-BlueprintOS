...
| B2.8 | Sourcing Intelligence | CNAE Principal | Persistir código e descrição do CNAE principal em `Fornecedor`; CNAEs secundários não entram no domínio. | B2.4. | Draft | [B2.8](work-orders/backlog/fase-b/B2.8-CnaePrincipal.md) | ADR-0023; seção H do relatório de arquitetura. | Pequena; pode ser paralela a B2.7. |
