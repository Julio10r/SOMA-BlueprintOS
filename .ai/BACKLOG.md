...
| Onda 2 — Cadastros | B1, B2, B2.1, B2.1.1, B2.1.2, B2.1.3, B2.2 (concluídas), B3 | Fornecedores já concluídos; Item Fiscal (B3 — Discovery homologado; Blocos 1–4 concluídos/homologados; cadastro único, sem catálogos separados de Material/Serviço), categorias, compradores e centros de custo entram nesta onda com sincronização ERP. |
...
| B3 | Sourcing Intelligence | Cadastro e Integração de Item Fiscal | Criar consulta ERP, cadastro próprio (Item Fiscal — cadastro único, sem catálogos separados de Material/Serviço), seleção manual e relacionamentos com fornecedores. | B1; B2.1 e B2.2. | Em andamento — Discovery homologado; Blocos 1–4 concluídos/homologados | [B3](work-orders/backlog/fase-b/B3-historico-de-compras.md) | Discovery homologado pelo Product Owner (`ContratoFuncionalPreliminar-B3-ItemFiscal.md`, `B3-ConsolidacaoFinalDiscovery.md`). Bloco 1 (Conta Contábil) e Bloco 2 (Unidade de Medida) — cadastros de apoio, leitura Linx real — concluídos/homologados. Bloco 3 (Item Fiscal — domínio, CRUD local, RBAC) e Bloco 4 (Referências por Fornecedor) concluídos/homologados (commit `c2365f5`, 02/09/2026). Bloco 5A (sincronização Linx → +Compras) ainda NÃO iniciado — próximo passo, após pré-validação de dados reais. Bloco 5B e Bloco 6 (Gate final) NÃO iniciados. | Detalhe completo em `.ai/PROJECT_STATE.md` e `applications/mais-compras/docs/product/B3-PlanoDeImplementacao.md`. |
