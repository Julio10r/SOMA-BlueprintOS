...
| B2.5 | Sourcing Intelligence | Situação Cadastral Canônica | Criar enum canônico interno de situação cadastral, eliminando o vazamento do valor numérico bruto do provider até o frontend (`StatusBadge`). | B2.4. | Draft | [B2.5](work-orders/backlog/fase-b/B2.5-SituacaoCadastralCanonica.md) | ADR-0023; seção J do relatório de arquitetura. | Pode ser paralela a B2.6 se as dependências reais permitirem. |
