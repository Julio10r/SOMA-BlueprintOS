# Work Order — C3 — Agente de Negociação
...
- Dependências: C2 e C5.
- Data de aprovação: Não aprovada

## Objetivo

Executar negociações assistidas ou automatizadas por canais controlados, mantendo contexto e regras de autonomia.
