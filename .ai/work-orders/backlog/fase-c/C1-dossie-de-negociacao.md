# Work Order — C1 — Dossiê de Negociação
...
- Dependências: B1, B3, B4 e B6.
- Data de aprovação: Não aprovada

## Objetivo

Consolidar histórico, fornecedor, preços, riscos, demanda, metas e argumentos antes da negociação.
