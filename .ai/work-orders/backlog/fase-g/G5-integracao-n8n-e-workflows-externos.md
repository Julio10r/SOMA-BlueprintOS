# Work Order — G5 — Integração n8n e Workflows Externos
...
- Dependências: G1, H1, H2 e H4.
- Data de aprovação: Não aprovada

## Objetivo

Permitir automações externas governadas, autenticadas, auditáveis e idempotentes.
