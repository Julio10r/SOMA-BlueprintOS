# Work Order — G3 — Integração ERP de Pedidos

## Metadados

- Fase: Marketplace & Integrations
- Sprint: G3
- Status: Draft
- Prioridade: Priorização pendente do Product Owner
- Dependências: G1 e B3; ERP a identificar.
- Data de aprovação: Não aprovada

## Objetivo

Criar, atualizar e consultar pedidos nos ERPs responsáveis por cada unidade de negócio.
