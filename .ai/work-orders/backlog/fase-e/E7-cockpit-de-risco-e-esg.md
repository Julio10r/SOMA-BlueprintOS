# Work Order — E7 — Cockpit de Risco e ESG

## Metadados

- Fase: Supplier Risk & ESG
- Sprint: E7
- Status: Draft
- Prioridade: Priorização pendente do Product Owner
- Dependências: E1 a E6; H1/H2 propostos.
- Data de aprovação: Não aprovada

## Objetivo

Exibir mapa de risco, evolução, criticidade, alertas, mitigação e exposição da cadeia.
