# Work Order — H5 — Segurança, LGPD e Governança de IA
...
- Dependências: H1 a H4.
- Data de aprovação: Não aprovada

## Objetivo

Implementar classificação de dados, retenção, consentimento, anonimização, controles e governança dos agentes.
