# Work Order — F1 — Camada Analítica de Compras

## Metadados

- Fase: Predictive Analytics
- Sprint: F1
- Status: Draft
- Prioridade: Priorização pendente do Product Owner
- Dependências: B3; persistência e integração propostas.
- Data de aprovação: Não aprovada

## Objetivo

Criar modelos de dados analíticos, indicadores, dimensões, fatos e pipelines de atualização.
...
B3; persistência e integração propostas.
