...
A Onda 1 está formalmente concluída (41/41, ver `.ai/PROJECT_STATE.md`). A Onda 2 abriu a frente Fornecedor/CNPJ (ADR-0023, `.ai/DECISIONS.md`): **[B2.3](completed/B2.3-DocumentoFiscalNormalizacaoEDigitoVerificador.md)**, **[B2.4](completed/B2.4-ContratoCanonicoConsultaCnpjETaxonomiaDeErros.md)**, **[B2.5](completed/B2.5-SituacaoCadastralCanonica.md)**, **[B2.6](completed/B2.6-StateMachineDeRevisaoNoFrontend.md)**, **[B2.7](completed/B2.7-ProvenienciaHibridaERetencao180Dias.md)** — Proveniência Híbrida da Consulta CNPJ + Snapshot Bruto com Retenção de 180 Dias — e **[B2.8](completed/B2.8-CnaePrincipal.md)** — CNAE Principal no Modelo Persistente de Fornecedor — foram concluídas e movidas para `completed/`. A Work Order restante dessa frente (**B2.9 — Adapter Linx**) foi **concluída tecnicamente em 17/08/2026** e movida para [`completed/`](completed/B2.9-AdapterLinxFornecedorCnpj.md): implementação real de escrita, testes automatizados, build e migrations verdes. A homologação manual pelo Visual Linx real foi postergada por decisão do Product Owner e incorporada ao **Gate Final de Homologação Manual da Onda 1**. A **O1.6 — Usuários (Backend Real)** permanece em [`backlog/`](backlog/) como próxima frente candidata do caminho crítico da Onda 1/administração.
