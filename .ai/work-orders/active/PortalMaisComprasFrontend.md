...
- Status: In Progress — frontend concluído tecnicamente (commit `8ee8f4e`), validação de backend (`dotnet build`/`dotnet test`) ainda pendente de execução local (ver `.ai/PROJECT_STATE.md` e `.ai/BACKLOG.md`)
...
- tokens em `resources/design-system/colors_and_type.css`;
- referencias em `resources/design-system/README.md`;
- UI kit em `resources/design-system/ui_kits/portal-gdt/`;
