...
export const PERMISSOES = {
  ...
  contaContabilGerenciar: "ContaContabil.Gerenciar",
  unidadeMedidaGerenciar: "UnidadeMedida.Gerenciar",
  itemFiscalVisualizar: "ItemFiscal.Visualizar",
  itemFiscalCriar: "ItemFiscal.Criar",
  itemFiscalEditar: "ItemFiscal.Editar",
  itemFiscalInativar: "ItemFiscal.Inativar",
