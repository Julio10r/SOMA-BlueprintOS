...
describe("CadastroFornecedor", () => {
  ...
  it("bloqueia o cadastro de fornecedor novo quando Nome Fantasia esta vazio", async () => {
    const fetchMock = mockFetch(consulta, []);
    renderCadastroFornecedor();
    ...
    const nomeFantasiaInput = screen.getByRole("textbox", { name: "Nome Fantasia *" });
    await userEvent.clear(nomeFantasiaInput);
