...
{
    /// <inheritdoc />
    public partial class AddUnidadeMedidaMetadadoB3Bloco2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "UnidadesMedidaMetadados",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnidadesMedidaMetadados", x => x.Id);
                });

            migrationBuilder.InsertData(
                table: "Permissoes",
                columns: new[] { "Id", "Codigo", "Descricao" },
                values: new object[] { new Guid("b1a5c4e0-0001-4a10-9f01-000000000015"), "UnidadeMedida.Gerenciar", "Ativar/inativar Unidades de Medida no +Compras e manter a Descrição +Compras" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "Permissoes",
                keyColumn: "Id",
                keyValue: new Guid("b1a5c4e0-0001-4a10-9f01-000000000015"));
        }
    }
}
