...
- PDF gerado com sucesso via `soffice --headless --convert-to pdf` (LibreOffice disponível em `/opt/homebrew/bin/soffice`): `docs/presentations/+COMPRAS Strategic Roadmap.pdf`.
