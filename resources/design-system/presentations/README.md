...
Convenções oficiais para qualquer apresentação `.pptx` gerada a partir do Design System. Templates reais em `resources/design-system/templates/powerpoint/`.
...
- PDF é o artefato de entrega/compartilhamento; o `.pptx` é o fonte editável — ambos versionados juntos em `resources/presentations/`.

## Convenções de nomenclatura

- Apresentações finais vivem em `resources/presentations/<Nome da Apresentação>.pptx` (+ `.pdf` irmão).
...
- Templates e masters reutilizáveis (não apresentações finais) vivem em `resources/design-system/templates/powerpoint/`, com nomenclatura fixa:
...
- Território **Corporate / Brand** apenas (ver `resources/design-system/SKILL.md`) — nunca aplicar o tema do Portal GDT em apresentações.
