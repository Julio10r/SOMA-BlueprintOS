...
O BlueprintOS usa exclusivamente a família **Lucide** (fork open-source do Feather Icons) para todo ícone de UI, apresentação ou documentação visual. Ver regra em `resources/design-system/SKILL.md` e `resources/design-system/README.md` (seção de iconografia).
